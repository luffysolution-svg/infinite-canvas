export default {
    ...
    config: {
        ...
        channelEditor: {
            ...
            vertexApiKeyLabel: "服务账号 JSON",
            vertexApiKeyPlaceholder: "粘贴 Google Cloud 服务账号 JSON，或点击右上角导入文件",
            vertexImport: "导入 JSON 文件",
            vertexImportSuccess: "已导入 Vertex AI 凭据",
            vertexImportInvalid: "JSON 文件无效，需包含 client_email、private_key、project_id 字段",
            vertexSecurityNote: "该凭据权限高于普通 API Key，等同于该服务账号在 GCP 项目中的全部权限，会和其他 API Key 一样保存在浏览器本地，请勿在公用设备导入，并为该服务账号单独授予最小权限。",
        },
        modelSelect: {
