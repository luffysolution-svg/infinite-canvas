export default {
    ...
    config: {
        ...
        channelEditor: {
            ...
            vertexApiKeyLabel: "Service account JSON",
            vertexApiKeyPlaceholder: "Paste a Google Cloud service account JSON key, or import a file from the button above",
            vertexImport: "Import JSON file",
            vertexImportSuccess: "Vertex AI credentials imported",
            vertexImportInvalid: "Invalid JSON file. It must include client_email, private_key, and project_id.",
            vertexSecurityNote: "This credential is far more powerful than a typical API key — it grants everything that service account can do in its GCP project. It is stored in the browser like other API keys, so avoid importing it on a shared device and grant that service account the minimum permissions it needs.",
        },
        modelSelect: {
